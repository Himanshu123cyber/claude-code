# 🎉 claude-code - Simplify Your Laravel Coding Experience
...
2. Add the marketplace:
   ...
   ```
3. Install the simplifier plugin:
   ```
...
### Using the Laravel Simplifier

Once you have installed the **laravel-simplifier**, you are ready to refine your code. 

To use the plugin:

1. After completing a coding session, head over to your command terminal.
2. Type the following command to review your recent changes:
   ```
   > Review recent changes using the laravel-simplifier agent
   ```

### Key Features of laravel-simplifier:
